                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.action_calendar:
                                Intent intent = new Intent(Profile.this, CalendarEvents.class);
                        ...
                        if (!oldPassword.equals("")){
                            ...
                            if (userInfo.getpassword().toString().equals(resultPassword)){
                                ...
                                if (newPassword.equals(repeatNewPassword)){
                                    ...
                                    if (succes){
                                        Dialog d = new Dialog("", "Changes has been saved", Profile.this);
                                        d.dialogOK();
                                    } else {
                                        Dialog d = new Dialog("", "Something went wrong, try again!", Profile.this);
                                        d.dialogOK();
                                    }
                                } else{
                                    Dialog d = new Dialog("", "Your repeated password is incorrect", Profile.this);
                                    d.dialogOK();
                                }
                            } else{
                                Dialog d = new Dialog("", "Your old password is incorrect", Profile.this);
                                d.dialogOK();
                            }
                        }
                        else{
